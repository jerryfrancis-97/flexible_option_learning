...
multi_options_folder_list = ["Fixedop_multi_option_noptions12_nruns10_nepisodes100_nsteps1000_fixed_eta_1.0",
                        "Fixedop_multi_option_noptions12_nruns10_nepisodes100_nsteps1000_LINEAR_eta_distance_cityblock",
                        "Fixedop_multi_option_noptions12_nruns10_nepisodes100_nsteps1000_LINEAR_eta_distance_euclidean"]
...
print("aafasfaf: ", fixed_eta_history_steps)
...
plt.title("Fixed Options")
plt.savefig("Graph1_Fixed_multioption_comparison.jpg")
plt.close("all")
